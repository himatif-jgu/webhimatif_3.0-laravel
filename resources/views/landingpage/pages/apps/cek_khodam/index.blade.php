@extends('landingpage.templates.khodam')
...
@section('content')
  <div class="wrap">
    <div class="card px-6 py-4">
      <div class="row-top">
        <div class="logo">Proyeksi Gaib HIMATIF</div>
      </div>
      <p class="subtitle">Uncover your coding spirit. Terminal AI kami akan menugaskan "guardian" — mulai dari makhluk legenda, bahasa pemrograman, hingga tools developer — lengkap dengan tier dan kekuatan khusus.</p>

      <!-- STEP 1: FORM NAMA -->
      <div id="stepForm" class="form">
        <input id="name" type="text" placeholder="Masukkan nama Anda…" autocomplete="off" />
        <button class="btn secondary" onclick="generateKhodamName()">Cek Kodam</button>
      </div>

      <!-- STEP 2: HASIL (disembunyikan dulu) -->
      <div id="stepResult" style="display:none">
        <p class="hello" id="hello">&nbsp;</p>
        <p class="sub">Khodam Anda adalah:</p>
        <h2 class="khodam" id="khodamTitle">—</h2>

        <div class="meta">
          <span class="pill common" id="rarityPill">Kelangkaan: Common</span>
          <span class="sep">/</span>
          <span id="elementText">Elemen: —</span>
        </div>

        <div class="power" id="powerWrap" style="display:none">
          <div class="power-row"><span>Power Level</span><span id="powerValue">0</span></div>
          <div class="bar"><span id="powerBar" style="width:0%"></span></div>
          <br>
        </div>
        ...
        <div class="grid-learn" id="learnGrid" style="display:none">
          <div class="tile"><h4>Lucky Stack</h4><div id="stack">—</div></div>
          <div class="tile"><h4>Fun Fact</h4><div id="funFact">—</div></div>
          <div class="tile"><h4>Quick Tip</h4><div id="tip">—</div></div>
        </div>
        ...
        <div class="share">
          ...
          <!-- <button class="btn tw" onclick="shareToTwitter()">Twitter</button> -->
          <button class="btn secondary" onclick="downloadCard()">Download Kartu</button>
          <button class="btn secondary" onclick="copyCaption()">Salin Teks</button>
          <button class="btn secondary" onclick="resetResult()">Cek Nama Lain</button>
        </div>
      </div>
    </div>
  </div>
