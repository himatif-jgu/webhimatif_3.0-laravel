<nav class="navbar">
  <div class="navbar-content">
    ...
    <div class="logo-mini-wrapper">
      <img src="{{ asset('assets/admin/images/logo-mini-light.png') }}" class="logo-mini logo-mini-light" alt="logo">
      <img src="{{ asset('assets/admin/images/logo-mini-dark.png') }}" class="logo-mini logo-mini-dark" alt="logo">
    </div>
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="#" id="profileDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          <img class="w-30px h-30px ms-1 rounded-circle object-fit-cover" src="{{ $authUser?->avatar ? asset('storage/'.$authUser->avatar) : url('https://placehold.co/30x30') }}" alt="profile">
        </a>
        <div class="dropdown-menu p-0" aria-labelledby="profileDropdown">
          <div class="d-flex flex-column align-items-center border-bottom px-5 py-3">
            <div class="mb-3">
              <img class="w-80px h-80px rounded-circle object-fit-cover" src="{{ $authUser?->avatar ? asset('storage/'.$authUser->avatar) : url('https://placehold.co/80x80') }}" alt="">
            </div>
            <div class="text-center">
              <p class="fs-16px fw-bolder">{{ $authUser?->name }}</p>
              <p class="fs-12px text-secondary">{{ $authUser?->email }}</p>
            </div>
          </div>
          <ul class="list-unstyled p-1">
            ...
            <li>
              <a href="#" class="dropdown-item py-2 text-body ms-0" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
