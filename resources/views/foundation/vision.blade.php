    ...
    <div class="boxed_wrapper ltr">
        ...
        <div id="search-popup" class="search-popup">
            <div class="popup-inner">
                <div class="upper-box">
                    <figure class="logo-box"><a href="index.html"><img src="../assets/landing/images/logo.png"
                                alt=""></a></figure>
        ...
        <div class="mobile-menu">
            ...
            <nav class="menu-box">
                <div class="nav-logo"><a href="index.html"><img src="../assets/landing/images/logo-2.png"
                            alt="" title=""></a></div>
                    ...
                    <div class="col-lg-8 col-md-12 col-sm-12 content-side">
                        <div class="job-details-content">
                            <div class="text-box mb_55">
                                <h3>Our Vision Himatif</h3>
                                <p>Realizing HIMATIF as a student association that is collaborative, innovative,
                                    interactive, and embraces each other,
                                    and can create a comfortable, active, solutive, and responsive environment for
                                    Informatics Engineering students.</p>
                            ...
                            <div class="text-box mb_55">
                                <h3>Work Program</h3>
                                <ul class="list-item">
                                    <li>Organizing collaborative and inclusive activities to strengthen the relationship
                                        among all Informatics Engineering students.</li>
                                    <li>Organizing training and workshops to improve the technical and non-technical
                                        skills of members.</li>
                                    <li>Building cooperation networks with other student associations, industries, and
                                        professional organizations.</li>
                                    <li>Managing an effective and transparent communication system for disseminating
                                        information to all members.</li>
                                    <li>Initiating social awareness-based activities to address current issues in
                                        society through technology.</li>
                            ...
                            <div class="text-box mb_65">
                                ...
                                <ul class="list-item">
                                    <li><strong>Skill Development:</strong> Gain access to exclusive training and
                                        workshops to improve industry-relevant <i>hard skills</i> and <i>soft
                                            skills</i>.</li>
                                    <li><strong>Extensive Network:</strong> Build strong relationships with fellow
                                        students, seniors, alumni, lecturers, and industry partners.</li>
                                    <li><strong>Career Opportunities:</strong> Connect with the professional world
                                        earlier through company visit programs, career seminars, and information on
                                        internship/job vacancies.</li>
                                    <li><strong>Innovation Hub:</strong> Get a supportive environment to channel ideas,
                                        collaborate on projects, and build a portfolio.</li>
                                    <li><strong>Organizational Experience:</strong> Learn leadership, project
                                        management, and teamwork, which are essential added values beyond lectures.</li>
                                </ul>
                            </div>
                            {{-- <ul class="share-box">
                                <li>
